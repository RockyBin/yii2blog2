 ...
 * @since 2.0
 */
class UnsignHttpException extends HttpException
{
    /**
     * Constructor.
     ...
     */
    public function __construct($message = null, $code = 250, \Exception $previous = null)
    {
        parent::__construct(250, $message, $code, $previous);
    }
}
